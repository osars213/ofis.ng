...
export const NetworkVisuals: React.FC<{ onExploreClick?: () => void }> = ({ onExploreClick }) => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto my-12 sm:my-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="rounded-3xl bg-[#111827]/70 backdrop-blur-xl border border-[#1F2937] p-6 sm:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.6)] relative overflow-hidden">
        
        {/* Subtle radial emerald background accent inside card */}
        <div className="absolute top-0 right-1/4 w-[500px] h-[300px] bg-[#10B981]/10 blur-[120px] rounded-full pointer-events-none" />

        {/* Header Strip of Dashboard */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-[#1F2937]/80">
          <div>
          ...
          <div className="flex items-center space-x-3">
            <div className="px-3.5 py-1.5 rounded-[12px] bg-[#030712]/80 border border-[#1F2937] text-xs text-[#94A3B8] flex items-center space-x-2">
              <span className="h-1.5 w-1.5 rounded-full bg-[#10B981]" />
              <span>99.8% Power SLA Verified</span>
            </div>
            <div className="hidden lg:flex px-3.5 py-1.5 rounded-[12px] bg-[#030712]/80 border border-[#1F2937] text-xs text-[#94A3B8] items-center space-x-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-6 items-center">
          ...
          <div className="lg:col-span-5 bg-[#030712]/80 border border-[#1F2937] rounded-2xl p-5 relative overflow-hidden min-h-[300px] flex flex-col justify-between">
            <div className="flex items-center justify-between z-10">
              ...
              <span className="text-[10px] font-mono text-[#34D399] bg-[#10B981]/10 px-2 py-0.5 rounded border border-[#10B981]/25">
                Live Telemetry
              </span>
            </div>
            ...
            <div className="relative w-full h-[220px] my-2">
              <svg className="w-full h-full" viewBox="0 0 100 100" fill="none">
                ...
                <path 
                  ...
                  className="fill-[#111827]/40 stroke-[#1F2937]/80 stroke-[0.7] stroke-dasharray-[2,2]"
                />

                {/* Connecting Arcs between active nodes */}
                <path 
                  d="M28 52 Q30 49 33 46" 
                  className="stroke-[#10B981]/60 stroke-[0.8]" 
                ...
                <path 
                  ...
                  className="stroke-[#34D399]/40 stroke-[0.5]" 
                  strokeDasharray="1 2"
                />
                <path 
                    ...
                    >
                      ...
                      {isActive && (
                        <circle 
                          ...
                          cy={node.y} 
                          r={isSelected ? "4.5" : "3"} 
                          className="fill-[#10B981]/20 animate-ping"
                        />
                      )}
                      <circle 
                        cx={node.x} 
                        ...
                        className={isActive ? "fill-[#10B981] stroke-[#F9FAFB] stroke-[0.5]" : "fill-[#94A3B8] opacity-60"}
                      />
                      {node.highlight && (
                        <text 
                          x={node.x + 3.5} 
                          y={node.y + 1} 
                          className="text-[3.5px] font-sans font-bold fill-[#F9FAFB] select-none"
                        >
                          {node.city}
                        </text>
                      )}
            ...
            <div className="p-3 rounded-xl bg-[#111827]/90 border border-[#1F2937] flex items-center justify-between text-xs z-10">
              <div className="flex items-center space-x-2.5">
                <div className="w-7 h-7 rounded-lg bg-[#10B981]/15 border border-[#10B981]/30 flex items-center justify-center text-[#34D399]">
                  <MapPin className="w-3.5 h-3.5" />
                </div>
                <div>
                  <div className="font-bold text-[#F9FAFB] leading-none mb-0.5">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-3.5">
            {featuredSpaces.map((space, idx) => (
              <div 
                key={idx}
                className="group rounded-2xl bg-[#030712]/90 border border-[#1F2937] hover:border-[#10B981]/40 overflow-hidden flex flex-col transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_28px_rgba(0,0,0,0.5),0_0_20px_rgba(16,185,129,0.08)]"
              >
                ...
                <div className="relative h-32 w-full overflow-hidden bg-zinc-900">
                  ...
                  <div className="absolute top-2.5 left-2.5 flex items-center space-x-1 px-2 py-0.5 rounded-md bg-[#030712]/80 backdrop-blur-md border border-white/10 text-[9px] font-semibold text-[#34D399]">
                  ...
                  <div className="absolute bottom-2 left-2.5 right-2.5 flex items-center justify-between text-[10px] text-zinc-300">
                    <span className="truncate flex items-center">
                      <MapPin className="w-3 h-3 mr-1 text-[#10B981] shrink-0" />
                      {space.location}
                    </span>
                  </div>
                </div>
                ...
                <div className="p-3.5 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <h4 className="text-xs sm:text-sm font-bold text-[#F9FAFB] line-clamp-1 group-hover:text-[#34D399] transition-colors">
                      {space.title}
                    </h4>
                    ...
                    <div className="mt-2.5 space-y-1">
                      {space.specs.map((spec, sIdx) => (
                        <div key={sIdx} className="flex items-center space-x-1.5 text-[10px] text-[#94A3B8]">
                          <Check className="w-2.5 h-2.5 text-[#10B981] shrink-0" />
                  ...
                  <div className="mt-3 pt-2.5 border-t border-[#1F2937] flex items-center justify-between text-xs">
                    <span className="font-semibold text-[#F9FAFB] text-[11px]">
                      {space.rate}
                    </span>
                    <span className="text-[10px] font-medium text-[#10B981] group-hover:underline flex items-center">
        ...
        <div className="mt-6 pt-4 border-t border-[#1F2937]/80 flex flex-wrap items-center justify-between gap-3 text-xs text-[#94A3B8]">
          <div className="flex items-center space-x-4">
            <span className="flex items-center space-x-1.5 text-[#F9FAFB]">
            ...
            <span className="text-zinc-600">•</span>
            <span className="hidden sm:inline-flex items-center space-x-1.5 text-[#F9FAFB]">
          ...
          <button
            ...
            className="text-[11px] font-semibold text-[#34D399] hover:text-[#10B981] flex items-center space-x-1 transition-colors group cursor-pointer"
          >
