...
const PARTNER_ITEMS: Partner[] = [
  {
    ...
    name: 'Szndpay',
    node: (
      <div className="flex items-center space-x-2.5 grayscale hover:grayscale-0 transition-all text-[#94A3B8] hover:text-[#FAF8F5] shrink-0 px-6 sm:px-8 py-2">
        <div className="w-7 h-7 rounded-lg bg-[#10B981]/20 border border-[#10B981]/40 flex items-center justify-center text-[#10B981] shadow-[0_0_12px_rgba(16,185,129,0.2)]">
          <svg className="w-4 h-4 text-[#10B981]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <span className="font-extrabold text-sm sm:text-base tracking-tight text-[#FAF8F5]">Szndpay</span>
      </div>
    )
  },
  {
...
export const TrustedLogos: React.FC = () => {
  return (
    <div className="relative w-full max-w-6xl mx-auto overflow-hidden py-3">
      ...
      <div className="pointer-events-none absolute left-0 top-0 bottom-0 w-16 sm:w-28 z-10 bg-gradient-to-r from-[#0C0B0A] via-[#0C0B0A]/80 to-transparent" />
      <div className="pointer-events-none absolute right-0 top-0 bottom-0 w-16 sm:w-28 z-10 bg-gradient-to-l from-[#0C0B0A] via-[#0C0B0A]/80 to-transparent" />
