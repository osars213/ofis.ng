      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-4">
            <span className="text-xs font-bold font-mono uppercase tracking-widest text-[#10B981]">Our Genesis</span>
          ...
          <div className="p-8 rounded-3xl bg-white dark:bg-[#172033] border border-[#E5E7EB] dark:border-[#1E293B] shadow-lg space-y-6">
            ...
            <ul className="space-y-3.5 text-xs text-[#4B5563] dark:text-[#CBD5E1]">
        ...
        <div className="space-y-8 pt-8 border-t border-[#E5E7EB] dark:border-[#1E293B]">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            <span className="text-xs font-bold font-mono uppercase tracking-widest text-[#10B981]">Physical Presence</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 rounded-3xl bg-white dark:bg-[#172033] border border-[#E5E7EB] dark:border-[#1E293B] text-center space-y-2">
              <Building2 className="w-8 h-8 text-[#10B981] mx-auto" />
              <h4 className="font-bold text-sm">Lagos State</h4>
              <p className="text-xs text-[#6B7280] dark:text-[#94A3B8]">VI, Lekki Phase 1, Ikoyi, Ikeja GRA, Yaba Hub</p>
            </div>

            <div className="p-6 rounded-3xl bg-white dark:bg-[#172033] border border-[#E5E7EB] dark:border-[#1E293B] text-center space-y-2">
              <Building2 className="w-8 h-8 text-[#10B981] mx-auto" />
              <h4 className="font-bold text-sm">Abuja (FCT)</h4>
              <p className="text-xs text-[#6B7280] dark:text-[#94A3B8]">Maitama, CBD, Wuse II, Jabi Lake</p>
            </div>

            <div className="p-6 rounded-3xl bg-white dark:bg-[#172033] border border-[#E5E7EB] dark:border-[#1E293B] text-center space-y-2">
              <Building2 className="w-8 h-8 text-[#10B981] mx-auto" />
              <h4 className="font-bold text-sm">Port Harcourt</h4>
              <p className="text-xs text-[#6B7280] dark:text-[#94A3B8]">Old GRA, Peter Odili, Trans-Amadi</p>
            </div>

            <div className="p-6 rounded-3xl bg-white dark:bg-[#172033] border border-[#E5E7EB] dark:border-[#1E293B] text-center space-y-2">
              <Building2 className="w-8 h-8 text-[#10B981] mx-auto" />
              <h4 className="font-bold text-sm">Ibadan</h4>
              <p className="text-xs text-[#6B7280] dark:text-[#94A3B8]">Bodija, Ring Road, Samonda Tech Park</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 sm:p-12 rounded-3xl bg-[#172033] border border-[#1E293B] text-white flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl">
          <div className="space-y-2 text-center sm:text-left">
            <h3 className="text-xl font-bold">Ready to experience OFIS?</h3>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-5 py-3 rounded-2xl bg-[#10B981] hover:bg-[#059669] text-white text-xs font-bold shadow-md cursor-pointer transition-all"
            >
              Explore Spaces
            </button>
            <button
